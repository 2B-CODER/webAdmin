...
<body>
	<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<tr class="info">
				<td>
				<select class="chzn-select" name="roleId" id="role_id" data-placeholder="请选择职位" style="vertical-align:top;">
				<option value=""></option>
			...
			<tr>
				<td><input type="text" name="remark" id="BZ"value="${pd.remark}" placeholder="这里输入备注" maxlength="64" title="备注"/></td>
			</tr>
			<tr>
