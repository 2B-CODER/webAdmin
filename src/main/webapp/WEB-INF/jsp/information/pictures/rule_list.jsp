	...
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<!-- 检索  -->
				<form action="consumeScoreRule/list.do" method="post" name="Form" id="Form">
					<table>
						<tr>
							<td>
					...
					<table id="table_report" class="table table-striped table-bordered table-hover">
						...
						<!-- 开始循环 -->
						<c:choose>
							<c:when test="${not empty ruleList}">
									<c:forEach items="${ruleList}" var="var" varStatus="vs">
										<tr>
											...
											<td>${var.id}</td>
											<td>${var.consumeMin}</td>
											<td>${var.consumeMax}</td>
											<td>${var.gainScore}</td>
...
<script type="text/javascript">
	...
	function add(){
		...
		window.location.href = '<%=basePath%>consumeScoreRule/add.do';
